...
CREATE TABLE IF NOT EXISTS `buyingstores` (
  ...
  `vending_currency` int(10) unsigned NOT NULL DEFAULT '0',  -- Pandas add for Vending Extend System
...
CREATE TABLE IF NOT EXISTS `char` (
  ...
  `view_control` BIGINT unsigned NOT NULL default '0',	-- Pandas added for view control system
  PRIMARY KEY  (`char_id`),
